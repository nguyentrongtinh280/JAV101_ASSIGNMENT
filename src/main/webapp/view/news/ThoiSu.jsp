...
            <c:when test="${not empty thoiSuList}">
                <c:forEach var="item" items="${thoiSuList}">

                    <%-- ĐÃ SỬA: Đổi class từ news-list-item thành news-item để khớp với CSS đã khai báo --%>
...
                                | <fmt:message key="thoisu.reporter" /> <%-- ĐÃ SỬA: Chuyển sang i18n --%>
                            </p>
                        </div>
